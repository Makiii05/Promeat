...
<body>
    ...
    <div class="container-lg py-4">
        <div class="profile-container">
            ...
            <form action="terminal_report.php" method="get">
            ...
            <table class="table table-striped">
                ...
                <?PHP
                    ...
                    $result = $conn->query("select * from tblsales where daily = '$date' and status = 'sold' and cashier = '$_SESSION[user_lastname], $_SESSION[user_givenname]'");
            ...
            <form action="../../2Print/p_terminal.php" method=get target="_blank" class="text-end">
                <input type="hidden" name=date value="<?PHP  echo $date?>">
                <input type="hidden" name=cashier value='<?PHP  echo "$_SESSION[user_lastname], $_SESSION[user_givenname]"?>'>
                <input type="submit" class="btn btn-secondary" name="print" value="Print Report">
            </form>
        </div>
    </div>
